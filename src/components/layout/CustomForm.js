...
const EditForm = (props) => {
  ...
  const { loading, updateSuccess, error, dispatch } = reducerProps;
    ...
    >
      ...
      <Form onSubmit={submitHandler}>
        ...
        <Modal.Footer>
          ...
          <SubmitButton variant="success" loading={loading} disabled={ loading || updateSuccess}>Submit</SubmitButton>
        </Modal.Footer>
      </Form>
      <ToastContainer />
    </Modal>
        ...
        <Col>
          <Card>
            ...
            <Form onSubmit={submitHandler}>
              ...
              <Card.Footer>
                <SubmitButton variant='success' loading={loading} disabled={loading}>Submit</SubmitButton>
              </Card.Footer>
            </Form>
          </Card>
        </Col>
